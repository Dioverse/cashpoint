      ...
      <>
        <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
                    <div className="app-brand demo">
                        ...
                        <span className="app-brand-text demo menu-text fw-bolder ms-2">Geteziplug</span>
                        </a>
                    ...
                    <ul className="menu-inner py-1">
                        ...
                        <li className="menu-item">
                            <a href="/admin/history/airtime" className="menu-link">
                                <i className="menu-icon tf-icons bx bx-cube-alt"></i>
                                <div data-i18n="Misc">History</div>
                            </a>
                        </li>
                        ...
                        {/* Misc */}
                        <li className="menu-header small text-uppercase"><span className="menu-header-text">Others</span></li>
                        <li className="menu-item">
                            <a
                                href="/admin/support"
                                target="_blank"
