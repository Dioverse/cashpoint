...
export default function CableHistory() {
    ...
    const fetchData = async (pageNum) => {
        setLoading(true);
        try {
            const res = await getRequest(`/histories/cable?page=${pageNum}&limit=${pageSize}`);
                ...
                <div className="layout-page">
                    ...
                    <div className="content-wrapper">
                        ...
                        <div className="container-xxl flex-grow-1 container-p-y">
                            ...
                            <h4 className="fw-bold py-3 mb-4"><span className="text-muted fw-light">Home /History</span> / Cable</h4>
                                                    ...
                                                    <table className="table">
                                                        ...
                                                        <tbody className="table-border-bottom-0">
                                                            ...
                                                            <tr key={index}>
                                                                ...
                                                                <td><a>{data.cable_plan.name}</a> </td>
